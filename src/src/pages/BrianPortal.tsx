...
const PIN = '2410' // 2410 North Forest Road — Landmark's address
...
export default function BrianPortal() {
  ...
  const [intakeForm, setIntakeForm] = useState<IntakeForm>({
    ...
    horizon: '10–20 years',
    notes: 'Tax-first financial planner — everything runs through the lens of after-tax outcomes. CPA background means I think about income, capital gains, Roth conversions, and estate transfer before I think about return optimization. I work closely with Landmark Tax Advisors on integrated planning. Fee-only fiduciary. When I evaluate a plan for a client, I ask: what does this cost them in taxes now, in 5 years, and at death?'
  })
    ...
    return (
      <div style={{
        ...
        <main style={{
          ...
          {activeSection === 'documents' && <DocumentsSection tenantId="brian" />}
        </main>
        <nav style={{
    ...
    <div style={{ maxWidth: '680px' }}>
      ...
      <div style={{ background: `${TEAL}08`, border: `1px solid ${TEAL}20`, borderRadius: '10px', padding: '20px 24px', marginBottom: '36px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          {[
            { label: 'Role', value: 'Co-founder & Partner · Landmark Wealth Management · Amherst, NY' },
            { label: 'Credentials', value: 'CPA · CFP · CIMA · AIF · Personal Financial Specialist · Certified Estate &amp; Trust Specialist · MBA, Notre Dame Mendoza' },
  ...
  if (saved) {
    return (
      <div style={{ maxWidth: '560px', textAlign: 'center', paddingTop: '40px' }}>
        ...
        <h2 style={{ fontSize: '28px', fontWeight: 900, marginBottom: '12px' }}>Got it, Brian.</h2>
    ...
    loadPersistedHistory().then(history => {
      if (history.length > 0) {
        ...
        setMessages([{
          role: 'assistant',
          content: intake
            ? "Hey Brian — I have your context loaded. Ask me anything — tax strategy, estate planning, client scenarios, or how AI fits into a CPA/CFP practice."
            : "Hey Brian — I'm Kit. Ask me anything — Roth conversion modeling, estate planning scenarios, tax-aware investing, or how AI fits into a fiduciary CPA practice."
        }])
      }
