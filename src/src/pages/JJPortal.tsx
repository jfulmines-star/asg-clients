...
export default function JJPortal() {
  ...
  const [intakeForm, setIntakeForm] = useState<IntakeForm>({
    aiToday: 'Claude API — everything runs through Anthropic',
    topChallenge: 'Demo-to-close conversion — need the aha moment to land faster in the room',
    clientType: ['FinTech / Wealth Management', 'CRE / Real Estate', 'Sales Teams'],
    sectors: ['Technology / AI', 'Financial Services'],
    horizon: '12–24 months',
    notes: 'ASG builds bespoke AI portals and agentic systems for mid-market professionals. Live clients: Landmark Wealth Management (Mark/Brian — financial advisors), Shield Technologies (Andy/Mark/Ryan — sales), Winthrop Realty Group (Blake — CRE). Core stack: React, Vite, Claude API, Supabase. This portal is JJ\'s own staging instance — used to QA Kit\'s performance, test new features, and validate flows before pushing to clients.',
  })
      ...
      <div style={{ minHeight: '100vh', background: BG, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: "'Inter', -apple-system, sans-serif" }}>
        <div style={{ width: '100%', maxWidth: '380px', textAlign: 'center' }}>
          ...
          <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: '20px', padding: '44px 40px 40px' }}>
            ...
            <div style={{ fontSize: '11px', letterSpacing: '4px', textTransform: 'uppercase', color: BLUE, fontWeight: 700, marginBottom: '8px' }}>
              STAGING / QA
            </div>
            ...
            <div style={{ fontSize: '14px', color: GRAY, marginBottom: '36px', lineHeight: '1.5' }}>
              AxiomStream Group<br />
              <span style={{ color: '#444', fontSize: '12px' }}>CEO &amp; Co-Founder</span>
            </div>
              ...
              {digits.map((d, i) => (
                <input
                  ...
                  style={{
                    ...
                    background: '#161616', border: `1.5px solid ${pinError ? '#ef4444' : d ? `${BLUE}60` : BORDER}`,
            ...
            <button
              ...
              style={{
                width: '100%', padding: '14px', background: BLUE, color: '#FAFAFA',
    ...
    <div style={{ minHeight: '100vh', background: BG, fontFamily: "'Inter', -apple-system, sans-serif", display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', color: BLUE, fontWeight: 700 }}>
            Staging / QA
          </div>
        </div>
      </header>
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <aside style={{
            ...
            >
              ...
              {item.tag && (
                <span style={{
                  ...
                  textTransform: 'uppercase', color: BLUE, background: `${BLUE}15`,
                  border: `1px solid ${BLUE}30`, borderRadius: '4px', padding: '2px 6px',
                }}>
                  {item.tag}
                </span>
              )}
          ...
          <div style={{ margin: '24px 20px 0', paddingTop: '20px', borderTop: `1px solid ${BORDER}` }}>
            <div style={{ fontSize: '11px', color: '#333', lineHeight: '1.6' }}>
              March 20, 2026<br />
              <span style={{ color: '#222' }}>Staging · ASG Internal</span>
            </div>
          </div>
        </aside>
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: '48px 48px 80px' }}>
          ...
          {activeSection === 'chat' && <JJChatSection intake={intakeSaved ? intakeForm : null} />}
          {activeSection === 'documents' && <DocumentsSection tenantId="jj" />}
        </main>
      </div>
...
function WelcomeSection({ onNavigate }: { onNavigate: (s: Section) => void }) {
  return (
    <div style={{ maxWidth: '680px' }}>
      <div style={{ fontSize: '10px', letterSpacing: '4px', textTransform: 'uppercase', color: BLUE, fontWeight: 700, marginBottom: '16px' }}>
        Welcome, JJ
      </div>
      <h1 style={{ fontSize: '42px', fontWeight: 900, lineHeight: '1.05', letterSpacing: '-1px', marginBottom: '20px' }}>
        Hey JJ. This is your<br /><span style={{ color: GOLD }}>staging environment.</span>
      </h1>
      <p style={{ fontSize: '17px', color: LIGHT_GRAY, lineHeight: '1.75', marginBottom: '24px', maxWidth: '540px' }}>
        You're running as a full client — same Kit instance, same portal architecture, same flows that Mark and Brian use. Use it to QA features, pressure-test Kit, and validate the experience before it reaches your clients.
      </p>

      {/* What we already know */}
      <div style={{ background: `${BLUE}08`, border: `1px solid ${BLUE}20`, borderRadius: '10px', padding: '20px 24px', marginBottom: '36px' }}>
        <div style={{ fontSize: '11px', letterSpacing: '3px', textTransform: 'uppercase', color: BLUE, fontWeight: 700, marginBottom: '14px' }}>
          What's Pre-Loaded
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          {[
            { label: 'Role', value: 'CEO & Co-Founder · AxiomStream Group · Buffalo / Remote' },
            { label: 'What ASG builds', value: 'Bespoke AI portals and agentic systems for mid-market professionals' },
            { label: 'Live clients', value: 'Landmark Wealth Management · Shield Technologies · Winthrop Realty Group' },
            { label: 'Agent roster', value: 'Kit (wealth/finance) · Rex (CRE/sales) · Atlas · Aria · Lex' },
            { label: 'Core stack', value: 'React + Vite · Claude API · Supabase · Recharts · RAG pipeline' },
            { label: 'This portal', value: 'JJ\'s own staging instance — identical to what Brian and Mark see. Full Kit context loaded.' },
            { label: 'What you\'re testing', value: 'Kit performance · chart rendering · document RAG · intake flows · new feature QA' },
            { label: 'Your edge', value: 'You built this. You know exactly where the gaps are. Use that.' },
          ].map(item => (
            <div key={item.label} style={{ background: '#0a0f1e', borderRadius: '6px', padding: '10px 12px' }}>
              <div style={{ fontSize: '9px', letterSpacing: '2px', textTransform: 'uppercase', color: BLUE, fontWeight: 700, marginBottom: '3px' }}>{item.label}</div>
              <div style={{ fontSize: '12px', color: LIGHT_GRAY, lineHeight: '1.5' }}>{item.value}</div>
            </div>
          ))}
        </div>
        <div style={{ marginTop: '12px', fontSize: '12px', color: '#444' }}>
          Your own product. Correct anything that's off in the "About You" section.
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '16px', marginBottom: '40px' }}>
        {[
          { id: 'stockbrief' as Section, icon: '📈', color: GOLD, title: 'Stock Brief', desc: 'Drop in any ticker — get institutional-grade analysis. Use it as a client would, then poke holes.' },
          { id: 'retirement' as Section, icon: '🏖️', color: '#34D399', title: 'Retirement Planner', desc: 'Full retirement plan generation. Pre-loaded with a sample client — adjust inputs, regenerate, see the diff.' },
          { id: 'aboutyou' as Section, icon: '🎯', color: '#A78BFA', title: 'About You', desc: 'Pre-filled with ASG context. Edit it, save it — then see how Kit changes in chat.' },
          { id: 'chat' as Section, icon: '💬', color: GOLD, title: 'Chat with Kit', desc: 'Kit with your full context loaded. Ask anything — charts, analysis, scenarios.' },
        ].map(card => (
          <button
            key={card.id}
      ...
      <div style={{ background: `${GOLD}08`, border: `1px solid ${GOLD}20`, borderRadius: '10px', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px', flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: '200px' }}>
          ...
          <p style={{ fontSize: '14px', color: LIGHT_GRAY, lineHeight: '1.7' }}>
            Open Chat and ask Kit to build a chart — try "show me NVDA vs MSFT revenue growth over 5 years as a bar chart." That's the fastest way to validate the chart rendering end-to-end.
          </p>
        </div>
        <button
  ...
  return (
    <div style={{ maxWidth: '680px' }}>
      ...
      <div style={{ background: `${GOLD}08`, border: `1px solid ${GOLD}20`, borderRadius: '8px', padding: '12px 16px', marginBottom: '28px', fontSize: '13px', color: LIGHT_GRAY, lineHeight: '1.6' }}>
        <span style={{ color: GOLD, fontWeight: 700 }}>Test it as a prospect would.</span> Try NVDA or MSFT — stocks your Landmark clients would actually ask about. See how the brief reads, what the institutional data shows, and how the "Landmark Lens" section lands. That's the section your clients care about most.
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '28px' }}>
        {[
          { label: 'Test ticker', value: 'NVDA', sub: 'NVIDIA — AI infrastructure, GPU dominance thesis' },
          { label: 'Test ticker', value: 'MSFT', sub: 'Microsoft — Azure + Copilot, enterprise AI moat' },
          { label: 'Test ticker', value: 'META', sub: 'Meta — AI infra capex, ad revenue durability' },
          { label: 'Test ticker', value: 'GOOG', sub: 'Alphabet — Gemini vs GPT, search disruption risk' },
          { label: 'Test ticker', value: 'AMZN', sub: 'Amazon — AWS + Bedrock, cloud AI leadership' },
        ].map(s => (
          <a
            key={s.value}
      ...
      <div style={{ background: `${BLUE}08`, border: `1px solid ${BLUE}20`, borderRadius: '10px', padding: '20px 24px' }}>
        <div style={{ fontSize: '13px', fontWeight: 700, color: BLUE, marginBottom: '8px' }}>
          The Landmark Lens
        </div>
        <p style={{ fontSize: '13px', color: LIGHT_GRAY, lineHeight: '1.7' }}>
          Every brief includes a section specific to the client firm — how this stock fits their practice, what their clients with positions are probably asking, and what a fee-only fiduciary sees that sell-side coverage misses. It knows their team's credentials and their firm's strategy.
        </p>
      </div>
    </div>
  )
...
function AboutYouSection({ form, setForm, saved, setSaved, onNavigate }: {
  ...
  if (saved) {
    return (
      <div style={{ maxWidth: '560px', textAlign: 'center', paddingTop: '40px' }}>
        ...
        <h2 style={{ fontSize: '28px', fontWeight: 900, marginBottom: '12px' }}>Got it, JJ.</h2>
        <p style={{ fontSize: '16px', color: LIGHT_GRAY, lineHeight: '1.7', marginBottom: '28px' }}>
          Your context is saved. Kit now knows ASG's current state, your client mix, and what you're testing. Every conversation in chat starts from there.
        </p>
        <button
          onClick={() => onNavigate('chat')}
          style={{
  ...
  const chipStyle = (active: boolean): React.CSSProperties => ({
    background: active ? `${BLUE}20` : SURFACE, border: `1px solid ${active ? BLUE : BORDER}`,
    borderRadius: '20px', padding: '6px 14px', fontSize: '13px', cursor: 'pointer',
    color: active ? BLUE : GRAY, fontFamily: "'Inter', sans-serif", transition: 'all 0.15s',
  })
  ...
  return (
    <div style={{ maxWidth: '600px' }}>
      ...
      <h2 style={{ fontSize: '36px', fontWeight: 900, letterSpacing: '-0.5px', marginBottom: '12px', lineHeight: '1.1' }}>
        Tell Kit About<br />ASG Right Now
      </h2>
      <p style={{ fontSize: '15px', color: LIGHT_GRAY, lineHeight: '1.7', marginBottom: '28px' }}>
        Pre-filled with current ASG context. Review it, correct anything that's out of date, and add what's top-of-mind. Kit will pull from this in every chat session.
      </p>
      <div style={{ background: `${GOLD}08`, border: `1px solid ${GOLD}20`, borderRadius: '8px', padding: '12px 16px', marginBottom: '28px', fontSize: '13px', color: GRAY }}>
        ✅ Pre-filled from ASG context — just review and save.
      </div>

      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>

        <div>
          <label style={labelStyle}>What AI tools does ASG use in production today?</label>
          <input
            type="text"
            placeholder="Claude API, Supabase, custom pipelines..."
            value={form.aiToday}
        ...
        <div>
          <label style={labelStyle}>What's the biggest friction in your sales or delivery process?</label>
          <input
            type="text"
            placeholder="Demo-to-close, onboarding, scoping, client education..."
        ...
        <div>
          <label style={labelStyle}>Client verticals you're targeting right now</label>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {['FinTech / Wealth Management', 'CRE / Real Estate', 'Sales Teams', 'Healthcare', 'Defense / Government', 'Other B2B'].map(v => (
        ...
        <div>
          <label style={labelStyle}>ASG product areas in active development or selling</label>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {['Technology / AI', 'Financial Services', 'Real Estate', 'Sales Intelligence', 'Document RAG', 'White-Label'].map(v => (
        ...
        <div>
          <label style={labelStyle}>Typical client engagement cycle</label>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {['Under 30 days', '1–3 months', '3–6 months', '12–24 months', '24+ months / ongoing'].map(v => (
        ...
        <div>
          <label style={labelStyle}>Anything else about ASG's current pipeline or how you work?</label>
          <textarea
            placeholder="Active clients, deals in motion, what's different about how ASG sells or delivers..."
            value={form.notes}
...
function JJChatSection({ intake }: { intake: IntakeForm | null }) {
  ...
  const msgUserBg    = isDark ? '#1e2a3a' : '#dbeafe'
  const msgUserBorder = isDark ? `${BLUE}30` : '#93c5fd'
  ...
  const intakeContext = intake ? `\n\n## JJ's Intake (filled in during this session)\nAI tools: ${intake.aiToday || 'not specified'}\nBiggest friction: ${intake.topChallenge}\nClient verticals: ${intake.clientType.join(', ')}\nProduct areas: ${intake.sectors.join(', ')}\nEngagement cycle: ${intake.horizon}\nNotes: ${intake.notes}` : ''
    ...
    loadPersistedHistory().then(history => {
      if (history.length > 0) {
        ...
        setMessages([{
          role: 'assistant',
          content: intake
            ? "Hey JJ — staging environment loaded with your context. Ask me anything, run a test scenario, or try 'show me a chart' to validate chart rendering end-to-end."
            : "Hey JJ — this is Kit. You're running in staging mode. Fill out the About You section to load your ASG context, then come back here and see how the experience changes. Or just ask me something now.",
        }])
      }
    ...
    <div style={{ maxWidth: '680px', display: 'flex', flexDirection: 'column', height: 'calc(100vh - 160px)', minHeight: '500px' }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ fontSize: '14px', color: GRAY, lineHeight: '1.6' }}>
          Full ASG context loaded — you're running as JJ. Charts, RAG, and full Kit capabilities active.
          {intake && <span style={{ color: BLUE }}> Intake saved ✓</span>}
        </p>
      </div>
        ...
        {messages.map((m, i) => (
          <div key={i} ref={i === messages.length - 1 ? lastMsgRef : undefined} style={{
            ...
            <div style={{
              ...
              background: m.role === 'user' ? '#1e2a3a' : `${GOLD}20`,
              border: `1px solid ${m.role === 'user' ? `${BLUE}40` : GOLD + '40'}`,
      ...
      <div style={{
        ...
        <textarea
          ...
          onKeyDown={handleKey}
          placeholder={messages.filter(m => m.role === 'user').length > 0 ? '' : "Ask about Kit, ASG clients, test chart rendering, or anything else..."}
          rows={2}
      ...
      <div style={{ marginTop: '8px', fontSize: '11px', color: '#333', textAlign: 'center' }}>
        Powered by AxiomStream Group · Staging / QA Environment
      </div>
  ...
  return (
    <div style={{ maxWidth: '760px' }}>
      ...
      <p style={{ fontSize: '15px', color: LIGHT_GRAY, lineHeight: '1.7', marginBottom: '12px' }}>
        Pre-loaded with a sample client profile — The Millers, a married couple 10 years from retirement. Walk through it, adjust any inputs, and generate an analysis on the spot.
      </p>
      ...
      >
        {loading ? (
          ...
          <>{generated ? '↺ Regenerate Analysis' : '→ Generate Analysis'}</>
        )}
      </button>
    ...
    <div style={{ maxWidth: '680px' }}>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '12px',
          background: dragOver ? `${BLUE}08` : '#0d0d0d',
          padding: '40px 24px',
          textAlign: 'center',
      ...
      {uploadStatus && (
        <div style={{
          background: uploadStatus.startsWith('✅') ? `${BLUE}15` : uploadStatus.startsWith('❌') ? '#ef444415' : `${GOLD}15`,
          border: `1px solid ${uploadStatus.startsWith('✅') ? BLUE : uploadStatus.startsWith('❌') ? '#ef4444' : GOLD}30`,
